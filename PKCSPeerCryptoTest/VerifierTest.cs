...
namespace PKCSPeerCryptoTest
{
    ...
    public class VerifierTest
    {
        ...
        [TestCase]
        public void Userquake_DataIsExpired()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
            string publicKey = "MEowDQYJKoZIhvcNAQEBBQADOQAwNgIxAOhqFvL7N/G2RlrluixV6efWsAaAA+9albM86Ltv9MJjwLBiJYAXZPI9UJY++COYOwIBEQ==";
        ...
        [TestCase]
        public void Userquake_InvalidDataSignature_Edited()
        {
        ...
        [TestCase]
        public void Userquake_InvalidDataSignature_Another()
        {
        ...
        [TestCase]
        public void Userquake_KeyIsExpired()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
            string publicKey = "MEowDQYJKoZIhvcNAQEBBQADOQAwNgIxAOhqFvL7N/G2RlrluixV6efWsAaAA+9albM86Ltv9MJjwLBiJYAXZPI9UJY++COYOwIBEQ==";
        ...
        [TestCase]
        public void Userquake_InvalidKeySignature_Edited()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
            string publicKey = "MEowDQYJKoZIhvcNAQEBBQADOQAwNgIxAOhqFvL7N/G2RlrluixV6efWsAaAA+9albM86Ltv9MJjwLBiJYAXZPI9UJY++COYOwIBEQ==";
        ...
        [TestCase]
        public void Userquake_InvalidKeySignature_Another()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
            string publicKey = "MEowDQYJKoZIhvcNAQEBBQADOQAwNgIxAOhqFvL7N/G2RlrluixV6efWsAaAA+9albM86Ltv9MJjwLBiJYAXZPI9UJY++COYOwIBEQ==";
        ...
        [TestCase]
        public void Userquake_AnotherPublicKey()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
        ...
        [TestCase]
        public void Userquake_CorruptedDataSignature()
        {
        ...
        [TestCase]
        public void Userquake_CorruptedKeySignature()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
            string publicKey = "MEowDQYJKoZIhvcNAQEBBQADOQAwNgIxAOhqFvL7N/G2RlrluixV6efWsAaAA+9albM86Ltv9MJjwLBiJYAXZPI9UJY++COYOwIBEQ==";
        ...
        [TestCase]
        public void Userquake_CorruptedPublicKey()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
        ...
        [TestCase]
        public void Userquake_CorruptedDataExpire()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
        ...
        [TestCase]
        public void Userquake_CorruptedKeyExpire()
        {
            string dataSignature = "0C/bVWbyqNRCbOijje6ihB/Xk+gcaBiBj8oN13kpP8n9CbesxIidbLp1EzcVAa/C";
            string dataExpire = "2018/02/27 03-29-32";
            string publicKey = "MEowDQYJKoZIhvcNAQEBBQADOQAwNgIxAOhqFvL7N/G2RlrluixV6efWsAaAA+9albM86Ltv9MJjwLBiJYAXZPI9UJY++COYOwIBEQ==";

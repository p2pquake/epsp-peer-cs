...
{
    public EPSPTsunamiEventArgs EventArgs { get; init; } = null!;
    public IFrameModel FrameModel { get; init; } = null!;

    public bool TestLabelVisible => EventArgs?.RegionList?.Any((region) => region.Region == "テスト予報区") ?? false;
    ...
    public string Source
    {
        get
        {
            if (EventArgs.IsCancelled)
                return "avares://P2PQuake/Resources/Icons/tsunami_gray.png";

            return Application.Current?.ActualThemeVariant == ThemeVariant.Dark
                ? "avares://P2PQuake/Resources/Icons/tsunami_yellow.png"
                : "avares://P2PQuake/Resources/Icons/tsunami_red.png";
        }
    }
    ...
    public string Caption
    {
        get
        {
            if (EventArgs.IsCancelled) return "津波予報 解除";
    ...
    private Map.Model.TsunamiCategory GetCategory(TsunamiCategory category) => category switch
    {
    ...
    public string? NoteFilename
    {
        get
        {
            if (EventArgs == null || EventArgs.IsCancelled) return null;
            ...
            return $"avares://P2PQuake/Resources/MapOverlays/tsunami_note_{category}.png";
        }
    }
    ...
    public Bitmap? BitmapImage
    {
        get
        {
            ...
            var mapDrawer = new MapDrawer()
            {
                ...
                TsunamiPoints = EventArgs.RegionList?.Select(e => new Map.Model.TsunamiPoint(e.Region, GetCategory(e.Category))).ToList() ?? new(),
                HideNote = true,
                PreferedAspectRatio = FrameModel.FrameWidth / FrameModel.FrameHeight,
            };
            return BitmapHelper.FromStream(mapDrawer.DrawAsPng());
        }
    }

    public Bitmap? EmptyBitmapImage
    {
        get
        {
            if (EventArgs == null) return null;
    ...
    public List<DetailItemView> DetailItemViewList
    {
        get
        {
            ...
            if (EventArgs is null) return list;
